const MOCK_INELIGIBLE_APPLICATION_EMAIL_TEMPLATE_ID = '7a0ce567-d908-4f35-a858-de9e8f5445ec'
...
describe('Process ineligible application', () => {
  ...
  beforeAll(() => {
    ...
    jest.mock('../../../../../app/auto-eligibility/config', () => ({
      ...
      emailTemplateIds: {
        ineligibleApplication: MOCK_INELIGIBLE_APPLICATION_EMAIL_TEMPLATE_ID
      }
    }))
  ...
  test('it sends an ineligible application email', async () => {
    ...
    expect(notifyClient.sendEmail).toHaveBeenCalledWith(
      MOCK_INELIGIBLE_APPLICATION_EMAIL_TEMPLATE_ID,
